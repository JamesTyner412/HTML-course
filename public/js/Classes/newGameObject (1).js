...
{	
	...
	this.drawSprite=function(){
		if(ready)
		{
			...
			/*let drawWidth ={
				x:(this.spriteData.states[this.currentState].width)?this.spriteData.states[this.currentState].width: this.width ,
				y:(this.spriteData.states[this.currentState].height)?this.spriteData.states[this.currentState].height: this.height}*/
